...
struct_file_222 = "BPOSCAR"
flux_dir = "flux_files_full_local_slow"
...
calc = MACE_flux_calculator(model_paths=model_file, device=device, default_dtype=dtype)
...
calc.init_full_local_flux(slow_method=True)
...
def print_heat(current_atoms=atoms, current_integrator=integrator):
    ...
    # and then the heat flux is not computed since it was not done at NVE yet.
