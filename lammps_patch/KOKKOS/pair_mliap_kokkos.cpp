...
void PairMLIAPKokkos<DeviceType>::compute(int eflag, int vflag)
{
  ...
  if (model->nonlinearflag || eflag)  {
    k_data->sync(descriptor_space, NUMNEIGHS_MASK | IATOMS_MASK | IELEMS_MASK | ELEMS_MASK | JATOMS_MASK | PAIR_I_MASK | JELEMS_MASK | RIJ_MASK | POSITIONS_MASK | VELOCITIES_MASK | MASSES_MASK);
  ...
  k_data->sync(descriptor_space, NUMNEIGHS_MASK | IATOMS_MASK | IELEMS_MASK | ELEMS_MASK | BETAS_MASK | JATOMS_MASK | PAIR_I_MASK | JELEMS_MASK | RIJ_MASK | POSITIONS_MASK | VELOCITIES_MASK | MASSES_MASK);  // SW added masks
